...
import style_extractor, information_extractor, keyword_extractor, generator

def main(platform, articles, max_items=10):
...
if __name__ == "__main__":
    ...
    print(main(platform=platform, articles=articles, max_items=max_items))
